...
/***/ function(module, exports, __webpack_require__) {
	...
	Todo.propTypes = {
	    todo: _react2.default.propTypes.shape({
	        ...
	        value: function render() {
	            ...
	            var todoList = this.state.todos.map(function (todo) {
	                return _react2.default.createElement(
	                    'li',
	                    { key: todo.id },
	                    _react2.default.createElement(Todo, { onDelete: _this3.deleteTodo, todo: todo })
	                );
	            });
	            return _react2.default.createElement(
	                'ul',
	...
	_reactDom2.default.render(_react2.default.createElement(TodoList, null), document.body);
